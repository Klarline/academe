...
from core.models import UserProfile, RAGFallbackPreference
...
class ResearchInterface:
    ...
    def _redirect_to_upload(self, user: UserProfile) -> None:
        ...
        from core.cli.document_interface import DocumentInterface
...
""",
    ...
    def _answer_from_general_knowledge(self, question: str, user: UserProfile) -> None:
        ...
        try:
            ...
            from core.agents.concept_explainer import explain_concept_with_context
