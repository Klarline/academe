...
from academe.graph.workflow import process_query_with_memory
...
class RAGASEvaluator:
    ...
    def get_system_response(
        ...
        try:
            # Use the v0.4 workflow with memory
            response, metadata = process_query_with_memory(
                question=question,
                user=user,
                conversation_id=conversation_id,
                use_memory=True
    ...
    def generate_report(
        ...
        report_lines = [
            "=" * 60,
            "ACADEME v0.4 EVALUATION REPORT",
            "=" * 60,
