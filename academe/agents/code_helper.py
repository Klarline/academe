...
Uses modern LangChain with structured Pydantic outputs for type-safe responses.

Now searches user's documents for code examples before generating.
"""

from typing import Optional, Dict, Any
from academe.config import get_llm
from academe.models import UserProfile, LearningLevel, LearningGoal
from academe.models.agent_responses import CodeGenerationResponse
