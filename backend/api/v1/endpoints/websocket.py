    ...
    try:
        ...
        while True:
            ...
            if message_type == "message":
                ...
                is_new_conversation = conversation_id.startswith("temp_")
                ...
                try:
                    chunk_count = 0
                    assistant_response = ""  # Collect full response
                    ...
                    async for event in chat_service.stream_message(
                        ...
                        assistant_response += chunk  # Accumulate response
                        
                        logger.debug(f"Sending chunk {chunk_count}: {event}")
                        await websocket.send_json({
                            "type": "stream_chunk",
                            "message_id": client_message_id,
                            "chunk": chunk,
                    ...
                    if is_new_conversation:
                        try:
                            ...
                            # Create conversation
                            real_conversation_id = conv_repo.create_conversation(
                                user_id=user_id,
