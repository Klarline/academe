...
async def get_conversations(
    ...
    all_conversations.sort(key=lambda c: c.last_message_at or c.created_at, reverse=True)
    ...
    conversation_responses = [
        ConversationResponse(
            id=conv.id,
            user_id=current_user_id,  # Use current_user_id instead of conv.user_id
            title=conv.title,
            created_at=conv.created_at,
            updated_at=conv.last_message_at or conv.created_at,  # Use last_message_at as updated_at
